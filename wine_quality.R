...
# knitr::purl("wine_quality_notebook.Rmd")
...
## ----create_test_and_train2, echo=TRUE-----------------------------------------------------------------------------------------
...
## ----rating_trend, echo=FALSE, fig.cap="Features Test Results"-----------------------------------------------------------------
...
## ----box_plot_facet, fig.width=7, fig.height=7, fig.cap="Test Result vs Quality", echo=FALSE-----------------------------------
